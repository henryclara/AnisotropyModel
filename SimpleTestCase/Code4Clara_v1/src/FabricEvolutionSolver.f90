 ...
 !!!!!  REAL(KIND=dp), POINTER :: a2(:),a20(:)
   ...
   IF(.NOT. GotIt) CALL Fatal( 'FabricEvolutionSolver','Could find value of Beta, Aborting.' )
   Gama = ListGetConstReal( Solver % Values,'Gamma', GotIt)
   IF(.NOT. GotIt) CALL Fatal( 'FabricEvolutionSolver','Could find value of Gamma, Aborting.' )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        F(4)=2*a4(7)*D(1) - a2(1)*D(4) - a2(4)*D(1) + 4*a4(3)*D(4) + &
             ...
             2*a4(9)*D(2) + 4*a4(5)*D(6) - a2(1)*W(1) + a2(2)*W(1) + &
             a2(5)*W(3) + a2(6)*W(2) - 2*D(3)*(a4(7) - a2(4) + a4(9))
        ...
        F(5)=2*a4(6)*D(1) + 4*a4(4)*D(4) + 3*a2(1)*D(5) - a2(5)*D(1) - &
             ...
             a2(5)*D(3) - a2(3)*D(5) - 2*a4(5)*D(3) - a2(1)*W(2) - &
        ...
        F(6)=2*a4(4)*D(1) - 4*a4(7)*D(5) + 3*a2(4)*D(5) - a2(5)*D(4) - &
             ...
             2*a4(8)*D(3) + a2(6)*D(3) - a2(3)*D(6) - a2(4)*W(2) - &
